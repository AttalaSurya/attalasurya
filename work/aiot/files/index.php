...
<html lang="en">
    <head>
        ...
        <title>AIoT EduTech Indonesia</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse fade-mayancepet" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-0 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="http://linktr.ee/aiottechnologyindonesia" target="_blank">Contact Us</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead" style="margin-bottom: 0%;">
            <div class="container">
                <div class="terbang"><img class="subju" src="assets/img/Tulisan.png"></div>
            </div>
        </header>
        <!-- Dua-->
        <section class="bg-light" style="margin: 0%; padding: 0%; background-image: url(assets/img/duaa.png); background-repeat:no-repeat; background-size: cover;">
        </section>
        <!-- Services-->
